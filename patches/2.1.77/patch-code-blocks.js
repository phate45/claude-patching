 ...
 *
 * 2.1.77 change: The guard variable (if(!$)) and the text prop (text:M)
 * are now different — a useMemo truncation creates a processed variable.
 * The regex captures the text prop independently instead of backreferencing.
 *
 * Usage:
...
//
// 2.1.77+: The guard variable (if(!GUARD)) and text prop (text:MEMO)
// may differ — a useMemo creates a truncated version for long messages.
// Pre-2.1.77: GUARD === MEMO (same variable).
// ============================================================
...
//
// We use memoTextVar (the text prop variable) for splitting — this is
// what Vyf would receive, including any truncation from useMemo.
